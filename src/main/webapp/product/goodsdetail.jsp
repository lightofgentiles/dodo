...
<link rel="stylesheet" type="text/css" href="${path}/css/goodsdetail.css">
<!-- JS, Popper.js, and jQuery -->
	...
	function autoCal(){
			  ...
			  if (x >= 1){
				  document.getElementById("totalScore").innerHTML = x*<%=pv.getP_price()%>;		
				  document.getElementById("totalScore1").value = x*<%=pv.getP_price()%>;	
			  }else{
...
<body>
	...
	<input type="hidden" id="IDX" name="IDX" value="${p_idx}">
	...
	<div style="width:100%; align:center; height:600px;">
		...
		<div style="float:left; margin-left:350px; width:26%;">
			<table border="0" width="500">
				<tr>
					<td><img src="${path}/images/p_images/<%=pv.getP_img()%>" width="500"
						height="700" /></td>
				</tr>
			</table>
		</div>
		...
		<div style="float:left; margin-left:30px; width:36%;">
			<table border="0">
				...
				<tr>
					<td id="goodsName">
						<font size="5" style="box-sizing: border-box; position: relative;"><%=pv.getP_name()%></font>
					</td>
				</tr>
				...
				<tr>
					<td id="price"
						...
						<fmt:formatNumber value="<%=pv.getP_price()%>" pattern="#,###" />원
					</td>
				</tr>
			</table>
			...
			<div class="totals-item totals-item-total" style="float:left; margin-left:400px;">
				<label class="total_price">수량</label>&nbsp;&nbsp;
	     		 <div class="total_price" style="float:right;">	
	     		 <input type="number" id="mySelect" value="1" style="width:30%;" onchange="autoCal();"/> 개</div>					
	      		<label class="total_price">총상품금액</label>&nbsp;&nbsp;
	     		 <div class="total_price" style="float:right;">원</div>
	      		<div class="totals-value" id="cart-total" style="float:right;">	
	      		 <label class="total_price" id="totalScore" name="totalScore"></label>&nbsp;&nbsp;
	      		 <input type="hidden" id="totalScore1" value="1" />
	      		</div>
	   	    </div>
			<br><br>
